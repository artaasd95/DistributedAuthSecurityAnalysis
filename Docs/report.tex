...
services:
    ...
    resource_server:
        build: ./secure_server
        environment:
            OIDC_ISSUER: http://keycloak:8080/realms/security-lab
            OIDC_AUDIENCE: fastapi-resource
            JWKS_URL: http://keycloak:8080/realms/security-lab/protocol/openid-connect/certs
        ports:
            - "8000:8000"
        depends_on:
            - keycloak
...
FORGED_PAYLOAD: {'exp': 1780091674, 'iat': 1780091374, 'auth_time': 1780091374, 'jti': '81d666c0-0c66-4d70-922d-91c0cfcde40c',
 'iss': 'http://localhost:8080/realms/security-lab', 'aud': 'account', 'sub': '63c4f288-e40f-493c-83e2-5ad53ce55e62', 'typ': 'Bearer',
...
"iss":"http://localhost:8080/realms/security-lab","aud":"account","sub":"63c4f288-e40f-493c-83e2-5ad53ce55e62","typ":"Bearer","azp":"secure-client",
